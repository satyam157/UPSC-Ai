...
HIGH_VALUE_KEYWORDS = [
    ...
    # v4.3.1 additions — Geography, Environment, and Culture (User-Driven Examples)
    "suru river", "panzella glacier", "pensi la", "zanskar mountain", "nun kun", "indus tributary",
    "sambhar lake", "saltwater lake", "aravalli hills", "ramsar site", "brine", "flamingoes",
    "phoniconaias minor", "phoenicopterus roseus", "lutjanus arakan", "snapper species",
    "rusty spotted cat", "smallest wild cat", "nocturnal behaviour", "deciduous forest",
    "scrubland", "grassland", "iucn near threatened", "cites appendix i", "wildlife protection act",
    "schedule i", "habitat loss", "poaching", "wildlife corridor", "protected area",
    "gopalpur-on-sea", "lutjanidae", "reef ecosystem", "coastal ecosystem", "zsi report",
    "silk road", "heritage connectivity", "ancient trade route", "mountain pass",
    "tributary", "river course", "estuary", "lagoon", "archipelago", "plateau",
    "monument conservation", "asi", "archaeological survey", "classical dance",
    "gi tag", "geographical indication", "tangible heritage",
    # Broad Category Additions for Geography, Environment, and Culture
    "critically endangered", "endangered species", "vulnerable species", "extinct in the wild",
    "biosphere reserve", "tiger reserve", "elephant reserve", "bird sanctuary", "national park",
    "endemic species", "invasive species", "keystone species", "indicator species",
    "drainage basin", "catchment area", "watershed", "river system", "glacier retreat",
    "ocean current", "el nino", "la nina", "indian ocean dipole", "monsoon trough",
    "folk dance", "carnatic music", "hindustani music", "temple architecture", "dravidian architecture",
    "nagara style", "vesara style", "buddhism", "jainism", "bhakti movement", "sufi movement",
    "mural painting", "miniature painting", "indus valley civilization", "harappan",
]
...
GENERIC_KEYWORDS = [
    ...
    "justice", "reform", "economic", "development",
...
HARD_BLACKLIST = [
    ...
    # ── Election & Political Parties (User Requested Exclusion) ───────────────
    "election", "poll", "voting", "voter", "political party", "campaign rally",
    "bjp", "congress", "aap", "tmc", "dmk", "biju janata dal", "samajwadi party",
    "manifesto", "seat sharing", "constituency", "by-poll", "exit poll",
    # ── Viral / clickbait ─────────────────────────────────────────────────────
